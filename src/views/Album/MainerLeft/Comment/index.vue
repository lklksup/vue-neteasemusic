...
export default {
    ...
    methods:{
        //获取评论
        async getComment(){
            let result = await this.$API.reqCommentAlbum(this.id,this.searchParams.pageSize,(this.searchParams.pageNo-1)*(this.searchParams.pageSize),localStorage.getItem('COOKIE'));
        ...
        // 获取热门评论
        async getCommentHot(){
            let result = await this.$API.reqCommentHot(this.id,3,localStorage.getItem('COOKIE'));
