...
export default {
    ...
    methods:{
        //获取评论
        async getComment(){
            let result = await this.$API.reqCommentPlayList(this.id,this.searchParams.pageSize,(this.searchParams.pageNo-1)*(this.searchParams.pageSize),localStorage.getItem('COOKIE'));
