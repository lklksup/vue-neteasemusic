<template>
  <div class="header-wrapper" ref="wrap">
    ...
    <div class="wrap">
      ...
      <input v-model="searchText" type="text" placeholder="音乐/视频/电台/用户" class="search" onfocus="this.placeholder=''"
        @focus="openSearch" onblur="this.placeholder='音乐/视频/电台/用户'" @blur="closeSearch" @keyup.enter="Search" />
    ...
    <div class="loginBox" v-show="isShowLogin">
      ...
      <div class="loginBoxWithCode" v-if="loginWithCode && !phoneLogin">
        <div style="width: 100%; height: 220px">
          ...
          <div class="qR">
            ...
            <img :src="qrUrl" />
            <span style="font-size: 12px">使用
              <a href="https://music.163.com/#/download" style="color: #0c73c2" target="_blank">网易云音乐APP</a>扫码登录</span>
          </div>
        </div>
        <div class="changE">
      ...
      <div class="loginBoxWithPhone" v-else-if="!loginWithCode && !phoneLogin">
        ...
        <div class="loginBoxWithPhoneBottom">
          ...
          <a href="https://st.music.163.com/official-terms/privacy">《隐私策略》</a>
      ...
      <div class="loginWithPhone" v-else>
        <div class="loginWithPhoneMainer">
          ...
          <div class="passwordWrapper" v-else>
            <input type="password" placeholder="请输入密码" v-model="password" @keyup.enter="loginButton" />
          </div>
          <!-- 切换至密码登录 -->
